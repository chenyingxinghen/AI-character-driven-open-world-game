...
describe('WorldManager', () => {
  ...
  describe('processLocationMovement', () => {
    it('should successfully move to an existing location', async () => {
      const result = await worldManager.processLocationMovement('town_square', 'tavern', 'player1', 'test_session');
    ...
    it('should dynamically create a new location and establish connections', async () => {
      const result = await worldManager.processLocationMovement('town_square', 'garden', 'player1', 'test_session');
    ...
    it('should fail when current location does not exist', async () => {
      const result = await worldManager.processLocationMovement('nonexistent', 'tavern', 'player1', 'test_session');
